(function ($) {
    ...
    */
    ...
    $(".vs-carousel").each(function () {
        var asSlide = $(this);
        //    var swipeToSlide = asSlide.data("swipe-to-slide") === true || asSlide.data("swipe-to-slide") === "true";
        ...
        asSlide.slick({
            ...
            prevArrow: d("prev-arrow") ?
                prevButton : '<button type="button" class="slick-prev"><i class="fa-solid fa-chevron-left"></i></button>',
            nextArrow: d("next-arrow") ?
                nextButton : '<button type="button" class="slick-next"><i class="fa-solid fa-chevron-right"></i></button>',
